...
function cargarAlmacenes(fecha) {
  ...
  getInventario(fecha).then(data => {
    ...
    const defaultCategorias = [
      ...
      { label: 'LACTEOS', test: i => /NESTLE LECHE CONDENSADA|NESTLE - CREMA DE LECHE|LA TABERNA CREMA DE COCO|GLORIA LECHE EVAPORDA|GLORIA LECHE CAJA|LECHE DE COCO|LECHE EVAPORADA DE COCO|LECHE PURA VIDA|BOLSA MANTEQUILLA|CREMA DE COCO|QUESO PARMESANO/i.test(i.nombre) },
