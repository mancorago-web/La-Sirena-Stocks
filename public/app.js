...
const FAMILIAS_COCINA = ['FRUTAS', 'VERDURAS', 'CARNE', 'PESCADO - BRUTO', 'PESCADO - BARRA FRIA', 'PESCADO - BARRA CALIENTE', 'POLLO', 'LACTEOS', 'VINOS', 'CERVEZAS', 'ABARROTES', 'LIMPIEZA', 'RECETAS BASE', 'SEMILLAS', 'ACEITES'];
...
function cargarPorcionamientoCocina(seleccionarItem) {
  ...
  Promise.all([
    ...
    const familiasPorcionamiento = ['PESCADO - BRUTO', 'PESCADO - BARRA FRIA', 'PESCADO - BARRA CALIENTE', 'CARNE', 'POLLO'];
...
const ORDEN_CATEGORIAS_COCINA = ['FRUTAS', 'VERDURAS', 'PESCADO - BRUTO', 'PESCADO - BARRA FRIA', 'PESCADO - BARRA CALIENTE', 'CARNE', 'POLLO', 'LACTEOS', 'ABARROTES', 'ACEITES', 'SEMILLAS', 'RECETAS BASE', 'LIMPIEZA', 'VINOS', 'CERVEZAS', 'OTROS'];
