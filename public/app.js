...
function verStockBarraGeneral() {
  ...
  const CATEGORIAS = [
    ...
    { label: 'LICORES', test: n => /LICOR|BARNIDET|BARDINET|AMARETTO|AMARETTTO|DISSARONO|DRAMBUIE|KAHLUA|KWAIFEH|GRAN KAFA|OURI|MOLINARI|FRANGELICO|BAILEYS|MALIBU|SAKE|SHO CHIKU BAI|GRANADINA|MATACUY/i.test(n) },
